...
* TODO Using org+babel for loading org file as init file
* TODO Move this file to my org directory
* Lexical binding
...
* TODO Package system and sources.
...
When set to a number in a list, try to get the width from any ~#+ATTR.*~ keyword if it matches a width specification like ~#+ATTR_HTML: :width 300px~ and fall back on that number if none is found.
...
...and finally finish configuring.
